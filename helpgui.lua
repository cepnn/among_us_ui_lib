...
--Extra gui stuff
JFR.NewText("a", bg, {Position = UDim2.new(0, 15, 0, 15), Size = UDim2.new(0, 400, 0, 25), Text = "Cepn's PL GUI - Help and Info", TextSize = 35, TextYAlignment = Enum.TextYAlignment.Center})
...
JFR.GetInstance("g").Text = game:HttpGet("https://raw.githubusercontent.com/cepnn/misc/main/helpguidesc.txt")
